            ...
            <section class="relative py-16 dark:bg-jacarta-800 md:py-24">
                ...
                <div class="container">
                    <div class="mx-auto max-w-lg text-center">
                        ...
                        <h1 class="mb-6 font-display text-4xl text-jacarta-700 dark:text-white md:text-6xl">Error!
                        </h1>
                        <p class="mb-12 text-lg leading-normal dark:text-jacarta-300">
                            Maaf, gambar yang anda submit tidak dapat kami prediksi saat ini. Silahkan coba lagi nanti.
                        </p>
                        <a href="{{ url('/') }}"
                            class="inline-block rounded-full bg-accent py-3 px-8 text-center font-semibold text-white shadow-accent-volume transition-all hover:bg-accent-dark">Navigate
                            Back Home</a>
                    </div>
                </div>
            </section>
